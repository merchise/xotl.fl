...
_lr_productions = [
  ...
  ('st_expr -> expr','st_expr',1,'p_standalone_expr','parser.py',281),
  ('st_expr -> PADDING expr','st_expr',2,'p_standalone_expr','parser.py',282),
  ('st_expr -> expr EOF','st_expr',2,'p_standalone_expr','parser.py',283),
  ('st_expr -> PADDING expr EOF','st_expr',3,'p_standalone_expr','parser.py',284),
  ('expr -> number','expr',1,'p_literals_and_basic','parser.py',297),
  ('expr -> concrete_number','expr',1,'p_literals_and_basic','parser.py',298),
  ('expr -> string','expr',1,'p_literals_and_basic','parser.py',299),
  ('expr -> char','expr',1,'p_literals_and_basic','parser.py',300),
  ('expr -> identifier','expr',1,'p_literals_and_basic','parser.py',301),
  ('expr -> enclosed_expr','expr',1,'p_literals_and_basic','parser.py',302),
  ('char -> CHAR','char',1,'p_char','parser.py',308),
  ('string -> STRING','string',1,'p_string','parser.py',313),
  ('identifier -> IDENTIFIER','identifier',1,'p_variable','parser.py',318),
  ('enclosed_expr -> LPAREN expr RPAREN','enclosed_expr',3,'p_paren_expr','parser.py',323),
  ('expr -> expr TICK_OPERATOR expr','expr',3,'p_infix_application','parser.py',328),
  ('expr -> expr SPACE expr','expr',3,'p_application','parser.py',333),
  ('expr -> enclosed_expr expr','expr',2,'p_application_after_paren','parser.py',338),
  ('expr -> expr enclosed_expr','expr',2,'p_application_after_paren','parser.py',339),
  ('expr -> expr DOT_OPERATOR expr','expr',3,'p_compose','parser.py',346),
  ('enclosed_expr -> LPAREN DOT_OPERATOR RPAREN','enclosed_expr',3,'p_operators_as_expressios','parser.py',353),
  ('enclosed_expr -> LPAREN operator RPAREN','enclosed_expr',3,'p_operators_as_expressios','parser.py',354),
  ('expr -> expr operator expr','expr',3,'p_user_operator_expr','parser.py',361),
  ('operator -> PLUS','operator',1,'p_operator','parser.py',370),
  ('operator -> MINUS','operator',1,'p_operator','parser.py',371),
  ('operator -> STAR','operator',1,'p_operator','parser.py',372),
  ('operator -> SLASH','operator',1,'p_operator','parser.py',373),
  ('operator -> DOUBLESLASH','operator',1,'p_operator','parser.py',374),
  ('operator -> PERCENT','operator',1,'p_operator','parser.py',375),
  ('operator -> ARROW','operator',1,'p_operator','parser.py',376),
  ('operator -> OPERATOR','operator',1,'p_operator','parser.py',377),
  ('number -> BASE10_INTEGER','number',1,'p_integer','parser.py',384),
  ('number -> BASE16_INTEGER','number',1,'p_integer','parser.py',385),
  ('number -> BASE8_INTEGER','number',1,'p_integer','parser.py',386),
  ('number -> BASE2_INTEGER','number',1,'p_integer','parser.py',387),
  ('number -> PLUS number','number',2,'p_pos_number','parser.py',409),
  ('number -> MINUS number','number',2,'p_neg_number','parser.py',414),
  ('number -> FLOAT','number',1,'p_float','parser.py',422),
  ('concrete_number -> number ANNOTATION string','concrete_number',3,'p_concrete_number','parser.py',427),
  ('concrete_number -> number ANNOTATION char','concrete_number',3,'p_concrete_number','parser.py',428),
  ('concrete_number -> number ANNOTATION identifier','concrete_number',3,'p_concrete_number','parser.py',429),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',438),
  ('expr -> BACKSLASH parameters ARROW expr','expr',4,'p_lambda_definition','parser.py',443),
  ('parameters -> IDENTIFIER _parameters','parameters',2,'p_parameters','parser.py',454),
  ('_parameters -> SPACE IDENTIFIER _parameters','_parameters',3,'p__params','parser.py',462),
  ('_parameters -> empty','_parameters',1,'p_empty__parameters','parser.py',469),
  ('pattern -> IDENTIFIER _pattern_params','pattern',2,'p_pattern','parser.py',494),
  ('_pattern_params -> SPACE IDENTIFIER _pattern_params','_pattern_params',3,'p_pattern_param','parser.py',500),
  ('_pattern_params -> empty','_pattern_params',1,'p_empty_pattern_param','parser.py',509),
  ('_pattern_params -> SPACE','_pattern_params',1,'p_empty_pattern_param','parser.py',510),
  ('equation -> pattern EQ expr','equation',3,'p_equation','parser.py',525),
  ('equations -> equation _equation_set','equations',2,'p_equation_set','parser.py',535),
  ('_equation_set -> PADDING equation _equation_set','_equation_set',3,'p_equation_set2','parser.py',544),
  ('_equation_set -> empty','_equation_set',1,'p_equation_set3','parser.py',553),
  ('letexpr -> KEYWORD_LET equations KEYWORD_IN expr','letexpr',4,'p_let_expr','parser.py',560),
  ('letrecexpr -> KEYWORD_LETREC equations KEYWORD_IN expr','letrecexpr',4,'p_let_expr','parser.py',561),
]
