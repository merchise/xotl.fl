...
_lr_productions = [
  ...
  ('datatype_definition -> KEYWORD_DATA SPACE IDENTIFIER _cons_args EQ _data_body','datatype_definition',6,'p_datatype_definition','parsers.py',920),
  ('_cons_args -> SPACE IDENTIFIER _cons_args','_cons_args',3,'p_datatype_cons_args','parsers.py',929),
  ('_cons_args -> empty','_cons_args',1,'p_datatype_cons_args2','parsers.py',940),
  ('_data_body -> data_cons _data_conses','_data_body',2,'p_datatype_body','parsers.py',946),
  ('_data_conses -> _maybe_padding PIPE data_cons _data_conses','_data_conses',4,'p_datatype_body','parsers.py',947),
  ('_data_conses -> empty','_data_conses',1,'p_datatype_conses_empty','parsers.py',956),
  ('data_cons -> IDENTIFIER _cons_args','data_cons',2,'p_data_cons','parsers.py',967),
]
