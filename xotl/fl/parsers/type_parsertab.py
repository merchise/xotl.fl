...
_lr_productions = [
  ...
  ('_param -> LPAREN pattern RPAREN','_param',3,'p_param_pattern','__init__.py',744),
  ('_param -> LBRACKET RBRACKET','_param',2,'p_empty_list_as_param','__init__.py',749),
  ('_param -> LPAREN RPAREN','_param',2,'p_unit_value_as_param','__init__.py',755),
  ('pattern_cons -> _identifier','pattern_cons',1,'p_pattern_cons','__init__.py',761),
  ('pattern_cons -> _enclosed_operator','pattern_cons',1,'p_pattern_cons','__init__.py',762),
  ('pattern -> pattern_cons _parameters','pattern',2,'p_pattern','__init__.py',768),
  ('equation -> pattern EQ expr','equation',3,'p_equation','__init__.py',773),
  ('equations -> equation _equation_set','equations',2,'p_equation_set','__init__.py',783),
  ('_equation_set -> PADDING equation _equation_set','_equation_set',3,'p_equation_set2','__init__.py',792),
  ('_equation_set -> empty','_equation_set',1,'p_equation_set3','__init__.py',801),
  ('letexpr -> KEYWORD_LET SPACE equations KEYWORD_IN SPACE st_expr','letexpr',6,'p_let_expr','__init__.py',811),
  ...
  ('type_expr -> type_function_expr','type_expr',1,'p_type_expr','__init__.py',834),
  ('type_expr -> type_term','type_expr',1,'p_type_expr','__init__.py',835),
  ('type_function_expr -> type_term ARROW _maybe_padding type_function_expr','type_function_expr',4,'p_type_function_expr','__init__.py',840),
  ('type_function_expr -> type_term','type_function_expr',1,'p_type_function_expr','__init__.py',841),
  ('type_term -> type_app_expression','type_term',1,'p_type_term','__init__.py',851),
  ('type_term -> type_factor','type_term',1,'p_type_term','__init__.py',852),
  ('type_app_expression -> type_factor _app_args_non_empty','type_app_expression',2,'p_type_application_expr','__init__.py',857),
  ('_app_args -> SPACE type_factor _app_args','_app_args',3,'p_type_application_args','__init__.py',869),
  ('_app_args_non_empty -> SPACE type_factor _app_args','_app_args_non_empty',3,'p_type_application_args','__init__.py',870),
  ('_app_args -> empty','_app_args',1,'p_type_application_args_empty','__init__.py',878),
  ('type_variable -> LOWER_IDENTIFIER','type_variable',1,'p_type_variable','__init__.py',883),
  ('type_cons -> UPPER_IDENTIFIER','type_cons',1,'p_type_cons','__init__.py',888),
  ('type_factor -> type_variable','type_factor',1,'p_type_factor_identifier','__init__.py',893),
  ('type_factor -> type_cons','type_factor',1,'p_type_factor_identifier','__init__.py',894),
  ('type_factor -> LPAREN _maybe_padding type_expr _maybe_padding RPAREN','type_factor',5,'p_type_factor_paren','__init__.py',901),
  ('type_factor -> LBRACKET _maybe_padding type_expr _maybe_padding RBRACKET','type_factor',5,'p_type_factor_bracket','__init__.py',906),
  ('_maybe_padding -> PADDING','_maybe_padding',1,'p_maybe_padding','__init__.py',911),
  ('_maybe_padding -> empty','_maybe_padding',1,'p_maybe_padding','__init__.py',912),
  ('program -> definitions','program',1,'p_program','__init__.py',918),
  ('definitions -> definition _definition_set','definitions',2,'p_definitions','__init__.py',934),
  ('_definition_set -> NEWLINE definition _definition_set','_definition_set',3,'p_definition_set','__init__.py',942),
  ('_definition_set -> empty','_definition_set',1,'p_definition_set2','__init__.py',950),
  ('definition -> nametype_decl','definition',1,'p_definition','__init__.py',956),
  ('definition -> valuedef','definition',1,'p_definition','__init__.py',957),
  ('definition -> datatype_definition','definition',1,'p_definition','__init__.py',958),
  ('valuedef -> equation','valuedef',1,'p_valuedef','__init__.py',964),
  ('nametype_decl -> _identifier COLON COLON st_type_expr','nametype_decl',4,'p_nametype_decl','__init__.py',970),
  ('nametype_decl -> LPAREN _st_operator RPAREN COLON COLON st_type_expr','nametype_decl',6,'p_nametype_decl_operators','__init__.py',979),
  ('datatype_definition -> _datatype_lhs EQ _data_rhs','datatype_definition',3,'p_datatype_definition','__init__.py',988),
  ('_datatype_lhs -> KEYWORD_DATA SPACE UPPER_IDENTIFIER _cons_params','_datatype_lhs',4,'p_datatype_lhs','__init__.py',996),
  ('_cons_params -> SPACE LOWER_IDENTIFIER _cons_params','_cons_params',3,'p_datatype_cons_params','__init__.py',1005),
  ('_cons_params -> empty','_cons_params',1,'p_datatype_cons_params_empty','__init__.py',1014),
  ('_data_rhs -> data_cons _data_conses','_data_rhs',2,'p_datatype_body','__init__.py',1020),
  ('_data_conses -> _maybe_padding PIPE data_cons _data_conses','_data_conses',4,'p_datatype_body','__init__.py',1021),
  ('_data_conses -> empty','_data_conses',1,'p_datatype_conses_empty','__init__.py',1030),
  ('data_cons -> _data_cons','data_cons',1,'p_data_cons','__init__.py',1035),
  ('_data_cons -> UPPER_IDENTIFIER _cons_args','_data_cons',2,'p_bare_data_cons','__init__.py',1041),
  ('_cons_args -> SPACE cons_arg _cons_args','_cons_args',3,'p_data_cons_args','__init__.py',1046),
  ('_cons_args -> empty','_cons_args',1,'p_data_cons_args_empty','__init__.py',1055),
  ('cons_arg -> type_variable','cons_arg',1,'p_cons_arg','__init__.py',1061),
  ('cons_arg -> type_cons','cons_arg',1,'p_cons_arg','__init__.py',1062),
  ('cons_arg -> _cons_arg_factor','cons_arg',1,'p_cons_arg','__init__.py',1063),
  ('_cons_arg_factor -> LPAREN type_expr RPAREN','_cons_arg_factor',3,'p_cons_arg_factor','__init__.py',1069),
  ('_cons_arg_factor -> LBRACKET type_expr RBRACKET','_cons_arg_factor',3,'p_cons_arg_factor_list','__init__.py',1075),
]
